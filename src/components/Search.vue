<template>
    <div v-if="showSearch" class="row my-2">
        <label class="col-1 col-form-label text-right">Search:</label>
        <input class="col-4 form-control" v-bind:value="searchTerm" 
        v-on:input="doSearch" placeholder="Enter search term..." />
