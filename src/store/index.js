...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        //     state.produtsTotal = data.pdata.length
    ...
    actions: {
        ...
        async getPage(context, getPageCount = 1) {
            ...
            context.commit("setPageCount", resp.headers["x-total-count"])
            context.commit("addPage", {number: context.state.currentPage, data: resp.data, pageCount: getPageCount})
        },
